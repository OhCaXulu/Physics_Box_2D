...
#define PIXEL_TO_METERS(pixels) (pixels*10)
...
bool ModulePhysics::Start()
{
	...
	body_def.position.Set(PIXEL_TO_METERS(500), PIXEL_TO_METERS(500));
	b2Body* body = world->CreateBody(&body_def);

	b2CircleShape BigCircle;
	BigCircle.m_radius = PIXEL_TO_METERS(radius);
...
update_status ModulePhysics::PostUpdate()
{
	...
	if (App->input->GetKey(SDL_SCANCODE_SPACE == KEY_DOWN))
	{
		...
		SmallCircle.m_radius = PIXEL_TO_METERS(30);
